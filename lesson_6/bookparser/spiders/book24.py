...
class Book24Spider(scrapy.Spider):
    ...
    def parse_book(self, response: HtmlResponse):
        ...
        price = response.xpath(
            '//div[contains(@class, "product-sidebar")]//div[contains(@class, "product-sidebar-price")]//span/text()').get()
        discount_price = response.xpath(
            '//div[contains(@class, "product-sidebar")]//div[contains(@class, "product-sidebar-price")]//div[@itemprop="offers"]//span/text()').get()
