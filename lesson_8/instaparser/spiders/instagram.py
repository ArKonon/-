...
class InstagramSpider(scrapy.Spider):
    ...
    insta_login = 'davydov.sarov'
    insta_pwd = ''
    parse_users = ['yurchaboatsman', 'ilya.diver']
    ...
    def user_data_parse(self, response: HtmlResponse, username):
        ...
        followers_url = f'{self.insta_api_link}friendships/{user_id}/followers/?' \
                        f'{urlencode(variables)}&search_surface=follow_list_page'

        subscriptions_url = f'{self.insta_api_link}friendships/{user_id}/following/?' \
